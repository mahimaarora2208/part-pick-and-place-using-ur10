...
#include "enpm809e_msgs/LogicalCameraImage.h"
#include "enpm809e_msgs/Model.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<enpm809e_msgs::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
  ...
  enpm809e_msgs::LogicalCameraImage imageMsg;
