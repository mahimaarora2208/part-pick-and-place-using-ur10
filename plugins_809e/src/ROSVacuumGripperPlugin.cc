...
#include "enpm809e_msgs/VacuumGripperControl.h"
#include "enpm809e_msgs/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    enpm809e_msgs::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  enpm809e_msgs::VacuumGripperControl::Request& _req,
  enpm809e_msgs::VacuumGripperControl::Response& _res)
{
...
{
  enpm809e_msgs::VacuumGripperState msg;
